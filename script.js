...
const formatMovementDate = function (date) {
  ...
  if (daysPassed >= 7 && daysPassed < 365)
    return `${Math.abs(daysPassed)} days ago`;
  if (daysPassed >= 365) {
    years = Math.floor(daysPassed / 365);
    console.log(years);
  }
...
// console.log(Math.min(5, 18, 1, 11, 2));
...
// console.log(43261789143261789432617894321n);
// console.log(BigInt(43261789143261789432617894321));
